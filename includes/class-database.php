...
class BR_Database {
    ...
    public static function install() {
        ...
        $sql_conversations = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}boreal_relay_conversations (
        ...
        $sql_knowledge = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}boreal_relay_knowledge (
            id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        ...
        $sql_escalations = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}boreal_relay_escalations (
            id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
            session_id VARCHAR(64) NOT NULL,
